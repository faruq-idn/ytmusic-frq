...
data class SearchUiState(
    ...
    val showResults: Boolean
        get() = (songs.isNotEmpty() || playlists.isNotEmpty() || albums.isNotEmpty() || artists.isNotEmpty()) && !isLoading
    
    val showSuggestions: Boolean
        get() = suggestions.isNotEmpty() && songs.isEmpty() && playlists.isEmpty() && albums.isEmpty() && artists.isEmpty() && query.isNotBlank() && !isLoading
    
    val showInitialState: Boolean
        get() = query.isBlank() && songs.isEmpty() && playlists.isEmpty() && albums.isEmpty() && artists.isEmpty() && !isLoading
}
